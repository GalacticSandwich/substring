/**
    ...
    The hashing function used in this implementation is the
    Rabin Fingerprint, which is a rolling hash that treats
    strings as numbers in base-256, modulo'ing by some
    prime number.
*/
